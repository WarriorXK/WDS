...
function ENT:CreateChargeSound()
	self.ChargeSound = CreateSound(self,"wds2/weapons/plasmacharger/charge.wav")
...
function ENT:Think()
	...
	if self.Charging and self.ChargeDelay <= CurTime() then
		...
		self.CurPitch = 40+(self.Charge*3.3)
	else
...
function ENT:FireShot()
	...
	self:EmitSound("wds2/weapons/plasmacharger/fire.wav")
